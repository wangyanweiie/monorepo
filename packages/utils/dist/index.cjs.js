 ...
 * 连接错误信息提示
 */
exports.HTTP_ERROR_NOTICE = void 0;
...
})(exports.HTTP_ERROR_NOTICE || (exports.HTTP_ERROR_NOTICE = {}));
/**
 * 操作提示
 */
exports.OPERATION_NOTICE = void 0;
...
})(exports.OPERATION_NOTICE || (exports.OPERATION_NOTICE = {}));
...
function setupAxiosInterceptors(options) {
     ...
     * 节流处理错误信息
     */
    const handleNetworkError = lodashEs.throttle((message) => {
     ...
     * 节流处理响应错误信息
     */
    const handleResponseError = lodashEs.throttle((options) => {
    ...
    service.interceptors.response.use((response) => {
        ...
        if (successStatus) {
            ...
            switch (responsedata.code) {
                case options.expireCode || -997:
                    handleResponseError({
                        type: 'warning',
                        message: exports.HTTP_ERROR_NOTICE.EXPIRE,
                        onClose: () => {
                ...
                default:
                    ...
                    elementPlus.ElNotification({
                        type: 'error',
                        message: message || exports.HTTP_ERROR_NOTICE.UNKNOWN,
                        zIndex: 9999,
                    });
                    return Promise.resolve(false);
            }
        ...
        if (!statusCode) {
            ...
            if (error.message.indexOf('timeout') !== -1) {
                handleNetworkError(exports.HTTP_ERROR_NOTICE.TIME_OUT);
            }
            else if (error.message.indexOf('Network Error') !== -1) {
                handleNetworkError(exports.HTTP_ERROR_NOTICE.NETWORK_ERROR);
            }
            else {
                handleNetworkError(exports.HTTP_ERROR_NOTICE.UNKNOWN);
            }
            return Promise.resolve(false);
        }
        // 非响应错误处理
        switch (statusCode) {
            case 404:
                handleNetworkError(exports.HTTP_ERROR_NOTICE.NOT_FOUND);
                break;
            case 500:
                handleNetworkError(exports.HTTP_ERROR_NOTICE.SERVER_ERROR);
                break;
            default:
                handleNetworkError(exports.HTTP_ERROR_NOTICE.UNKNOWN);
                break;
...
exports.checkNumberFormat = checkNumberFormat;
exports.clearStorage = clearStorage;
exports.getStorage = getStorage;
exports.handleToHumpFormat = handleToHumpFormat;
exports.keepDecimalPrecision = keepDecimalPrecision;
exports.removeStorage = removeStorage;
exports.saveStorage = saveStorage;
exports.setupAxiosInterceptors = setupAxiosInterceptors;
exports.to = to;
exports.transformEnumToOptions = transformEnumToOptions;
