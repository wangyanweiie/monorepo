...
function writeAPI() {
    ...
    return __awaiter(this, void 0, void 0, function () {
        let apiList, res, pathObj_1, tagsList_1, conversionData, res2, writeData, key, funName, method, error_1;
        const _this = this;
        return __generator(this, function (_b) {
            switch (_b.label) {
                case 0:
                    _b.trys.push([0, 2, , 3]);
                    apiList = ['http://192.168.3.201:8002/v3/api-docs?group=%E7%B3%BB%E7%BB%9F%E6%9C%8D%E5%8A%A1'];
                    return [
                        4 /*yield*/,
                        Promise.all(
                            apiList.map(function (items) {
                                return __awaiter(_this, void 0, void 0, function () {
                                    let respon;
                                    return __generator(this, function (_a) {
                                        switch (_a.label) {
                                            case 0:
                                                return [4 /*yield*/, axios_1.default.get(items)];
                                            case 1:
                                                respon = _a.sent();
                                                if (!respon) {
                                                    return [2 /*return*/, []];
